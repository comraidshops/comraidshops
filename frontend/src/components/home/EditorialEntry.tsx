...
export default function EditorialEntry({ initialArticle }: EditorialEntryProps) {
    ...
    const getLongPreview = () => {
        const primaryContent = magazine.articles?.[0]?.content || magazine.description || "";

        // If content is empty or too short, use the requested "Art of Suffering" narrative as the high-quality preview
        ...
        const finalContent = stripped.length > 300 ? stripped : narrative;
